      ...
      return (
        ...
        <ScrollView style={{backgroundColor:"white"}}>
          ...
          {Employee.map((employee, index) => (
            <TouchableOpacity key={index} style={{ margin:2,marginLeft:7,marginRight:7, padding: 2, borderRadius: 10,flexDirection:"row",justifyContent:"space-between",alignItems:"center"}}>
            ...
            />
                <View>
                <Text style={{fontSize:20,fontWeight:600,color:"white",marginHorizontal:10,color:"black"}}>{employee.Name}</Text>
                <Text style={{fontSize:10,fontWeight:600,color:"white",marginHorizontal:10,color:"black"}}>{employee._id}</Text>
